...
export const searchShingLing: TShingLing[] = [
  ...
  {
    id: 7,
    label: "Плессировочная машина",
    navigate: "https://shingling.com.tw/en/product-category/sl-8800n-series/",
    images: "/images/shing_ling/pless_machine_no_bg.png",
    types: "shing_ling",
  },
  {
    id: 8,
    label: "Примострочная машины",
    navigate: "https://shingling.com.tw/en/product-category/sl-900-ii-series/",
    images: "/images/shing_ling_new/19.png",
    types: "shing_ling",
  },
];

        ...
        <ul className="flex gap-2.5 mt-2.5">
          {colors.map((color, index) => (
            <li
              ...
              className={`w-5 h-5 rounded-full cursor-pointer relative after:absolute after:left-1/2 after:top-1/2 after:-translate-y-1/2 after:-translate-x-1/2 after:w-7 after:h-7 after:rounded-full ${color === selectColor ? "after:border after:border-[#E5E2E1]" : ""}`}

...
const PageHeader = ({ pageTitle, breadcrumbLink, breadcrumbLabel, currentPage }: PropsType) => {
  return (
      ...
      <div className='lg:py-20 py-12 text-center'>
        ...
        <ul className='text-base leading-[162%] flex items-center justify-center gap-0.5 mt-[15px]'>
          <li className='flex items-center gap-0.5'>
            <Link href={"/"} className='text-gray-2-foreground hover:text-white transition-all duration-500'>Home</Link>

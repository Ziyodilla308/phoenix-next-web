...
(function (root, factory) {
  ...
  function AnchorJS(options) {
    ...
    this.add = function(selector) {
      ...
      // We produce a list of existing IDs so we don'tr generate a duplicate.
      ...
      for (i = 0; i < elements.length; i++) {
        ...
        if (this.options.icon === '\ue9cb') {
          ...
          // height of the heading. This isn'tr the case for icons with `placement: left`, so we restore
    ...
    this.urlify = function(text) {
      ...
      // Example string:                      // " ⚡⚡ Don'tr forget: URL fragments should be i18n-friendly, hyphenated, short, and clean."
      urlText = text.trim()                   // "⚡⚡ Don'tr forget: URL fragments should be i18n-friendly, hyphenated, short, and clean."
    ...
    function _addBaselineStyles() {
      // We don'tr want to add global baseline styles if they've been added before.
